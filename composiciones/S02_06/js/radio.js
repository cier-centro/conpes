   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
        ...
        for (i=1; i<=condCreated; i++ ){
			...
			Cookies.set('S02_06_score',(5-errores)+'');
			console.log(Cookies.get('S02_06_score'));
         //document.cookie = "S02_06_score="+(5-errores); //Asumiendo que todos los bloques tenen 5 preguntas           
         });
         //BOTÓN SOLUCIÓN
