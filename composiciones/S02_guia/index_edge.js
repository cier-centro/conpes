...
"stage": {
    ...
    states: {
        "Base State": {
            ...
            "${_cerrar_gray}": [
                ["style", "top", '78px'],
                ["transform", "scaleY", '0.62034'],
                ["style", "left", '1292px'],
                ["transform", "scaleX", '0.62034']
            ],
            "${_Stage}": [
            ...
            dom: [
                {
                    ...
                    clip: ['rect(325.38671875px 1366px 678.39453125px 546.7451171875px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido_1.png', '0px', '0px']
                },
                {
                    type: 'image',
                    id: 'contenido_1Copy6',
                    rect: ['-2px', '111px', '1366px', '772px', 'auto', 'auto'],
                    clip: ['rect(101.75048828125px 1366px 212.93994140625px 546.7451171875px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido_1.png', '0px', '0px']
                },
                {
                    type: 'image',
                ...
                },
                {
                    id: 'guia',
                    type: 'image',
                    rect: ['489px', '117px', '646px', '76px', 'auto', 'auto'],
                    fill: ['rgba(0,0,0,0)', 'images/guia.png', '0px', '0px']
                }
            ],
            symbolInstances: [
            {
    ...
    states: {
        "Base State": {
            "${_contenido_1}": [
                ["style", "top", '0px'],
                ["style", "opacity", '0'],
                ["style", "clip", [325.38671875,1366,678.39453125,546.7451171875], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "left", '293px']
            ],
            "${_guia}": [
                ["style", "top", '117px'],
            ...
            "${_contenido_1Copy6}": [
                ...
                ["style", "opacity", '0'],
                ["style", "left", '293px'],
                ["style", "clip", [101.75048828125,1366,212.93994140625,546.7451171875], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ]
            ],
            "${_boton_next}": [
                ["style", "top", '779px'],
                ["style", "left", '1275px'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid462", tween: [ "style", "${_contenido_1Copy6}", "left", '-2px', { fromValue: '293px'}], position: 500, duration: 750, easing: "easeOutExpo" },
                ...
                { id: "eid465", tween: [ "transform", "${_guia}", "scaleX", '1', { fromValue: '0'}], position: 0, duration: 500, easing: "easeOutBack" },
                ...
                { id: "eid463", tween: [ "style", "${_contenido_1Copy6}", "opacity", '1', { fromValue: '0'}], position: 500, duration: 750, easing: "easeOutExpo" },
                ...
                { id: "eid467", tween: [ "transform", "${_guia}", "scaleY", '1', { fromValue: '0'}], position: 0, duration: 500, easing: "easeOutBack" }            ]
        }
    }
},
"guia_2": {
