    ...
    content: {
            dom: [
                ...
                },
                {
                    ...
                    id: 'contenido2',
                    display: 'none',
                    clip: ['rect(0px 780.375px 222.40625px 212.578125px)'],
                ...
                },
                {
                    ...
                    id: 'contenido2Copy2',
                    display: 'none',
                    clip: ['rect(477.53125px 1366px 562.3125px 0px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                    ...
                    id: 'contenido2Copy',
                    display: 'none',
                    clip: ['rect(566.265625px 1366px 651.640625px 0px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                    ...
                    id: 'contenido2Copy3',
                    display: 'none',
                    clip: ['rect(384.6015625px 1366px 472.5625px 0px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                    ...
                    id: 'contenido2Copy4',
                    display: 'none',
                    clip: ['rect(296.9140625px 1366px 382.4375px 0px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
                    ...
                    id: 'contenido2Copy5',
                    display: 'none',
                    clip: ['rect(231.171875px 1366px 293.0234375px 33.7890625px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
                    rect: ['0px', '0px', '1366px', '768px', 'auto', 'auto'],
    ...
    states: {
        "Base State": {
            "${_contenido2Copy3}": [
                ...
                ["style", "display", 'none'],
                ["style", "opacity", '0'],
                ["style", "clip", [384.6015625,1366,472.5625,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "left", '-958px']
            ],
            "${_contenido2}": [
                ["style", "top", '0px'],
                ["style", "display", 'none'],
                ["style", "clip", [0,780.375,222.40625,212.578125], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
            ...
            "${_contenido2Copy5}": [
                ...
                ["style", "display", 'none'],
                ["style", "opacity", '0'],
                ["style", "clip", [231.171875,1366,293.0234375,33.7890625], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "left", '-958px']
            ],
            "${_contenido2Copy}": [
                ["style", "top", '0px'],
                ["style", "display", 'none'],
                ["style", "opacity", '0'],
                ["style", "clip", [566.265625,1366,651.640625,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "left", '-958px']
            ],
            "${symbolSelector}": [
                ["style", "height", '200px'],
            ...
            "${_contenido2Copy4}": [
                ...
                ["style", "display", 'none'],
                ["style", "opacity", '0'],
                ["style", "clip", [296.9140625,1366,382.4375,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "left", '-958px']
            ],
            "${_contenido2Copy7}": [
                ["style", "top", '0px'],
            ...
            "${_contenido2Copy2}": [
                ...
                ["style", "display", 'none'],
                ["style", "opacity", '0'],
                ["style", "clip", [477.53125,1366,562.3125,0], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "left", '-958px']
            ]
        }
    },
