    ...
    content: {
            dom: [
                ...
                },
                {
                    ...
                    id: 'contenido2Copy7',
                    display: 'none',
                    clip: ['rect(79.8828125px 211.5078125px 148.955810546875px -3.5390625px)'],
                    fill: ['rgba(0,0,0,0)', 'images/contenido.png', '0px', '0px']
                },
                {
    ...
    states: {
        "Base State": {
            ...
            "${_contenido2Copy7}": [
                ...
                ["style", "clip", [79.8828125,211.5078125,148.955810546875,-3.5390625], {valueTemplate:'rect(@@0@@px @@1@@px @@2@@px @@3@@px)'} ],
                ["style", "left", '0px']
            ],
            "${_bg2}": [
                ["style", "top", '0px'],
