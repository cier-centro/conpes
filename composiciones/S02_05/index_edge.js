...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'bt_validar',
                type: 'rect',
                rect: ['925px', '696px','auto','auto','auto', 'auto']
            },
            {
                id: 'bt_solucion',
                type: 'rect',
            ...
            },
            {
                id: 'bt_reiniciar',
                type: 'rect',
                rect: ['1060px', '696px','auto','auto','auto', 'auto']
            },
            {
                id: 'bt_ayuda',
                type: 'rect',
                rect: ['1123px', '696px','auto','auto','auto', 'auto']
            },
            {
                id: 'hotspot_ayuda',
                type: 'rect',
                rect: ['1123px', '696px','66px','64px','auto', 'auto'],
                cursor: ['pointer'],
            ...
            },
            {
                ...
                type: 'rect',
                rect: ['1060px', '696px','66px','60px','auto', 'auto'],
                cursor: ['pointer'],
                fill: ["rgba(192,192,192,0.00)"],
                stroke: [0,"rgba(0,0,0,1)","none"]
            },
            ...
            },
            {
                id: 'hotspot_validar',
                type: 'rect',
                rect: ['925px', '696px','66px','61px','auto', 'auto'],
                cursor: ['pointer'],
                fill: ["rgba(192,192,192,0.00)"],
                stroke: [0,"rgba(0,0,0,1)","none"]
            },
